    ...
    def create_bucket_if_not_exists(self, bucket_name):
        ...
        try:
            ...
            if bucket_name not in existing_buckets:
                ...
                # Define the bucket policy for full public access
                # Define the bucket policy for public access under the '/anonymous' prefix
                 # Define the bucket policy for public read/write on all objects in the bucket
                bucket_policy = {
                    "Version": "2012-10-17",
                    "Statement": [
                        {
                            "Sid": "AnonymousReadWrite",
                            "Effect": "Allow",
                            "Principal": "*",
                            "Action": "s3:*",
                ...
                print(f"Bucket '{bucket_name}' is now fully public (read & write).")
            else:
