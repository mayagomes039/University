...
export const useProjectStore = defineStore('project', () => {
    ...
    const fetchProjects = async (userId) => {
        try {
            ...
            const response = await axios.get(`http://localhost:3000/api/projects/project/user/${userId}`, {withCredentials: true});
    ...
    const uploadImages = async (files, projectId) => {
        ...
        try {
            ...
            const response = await axios.post(
                `http://localhost:3000/api/projects/image/${projectId}`,
                formData,
                {
                    headers: {
    ...
    const uploadZip = async (zipFile, projectId) => {
        try {
            ...
            const response = await axios.post(
                `http://localhost:3000/api/projects/image/zip/${projectId}`,
                formData,
                {
                    headers: {
                        'Content-Type': 'multipart/form-data',
    ...
    const deleteImage = async (projectId, imageId) => {
        try {
            const response = await axios.delete(`http://localhost:3000/api/projects/image/${projectId}/${imageId}`, { withCredentials: true })
    ...
    const downloadImage = async (project_name, projectId) => {
        try {
            ...
            const response = await axios.post(`http://localhost:3003/api/image/download/${projectId}`, {}, {
                responseType: 'blob',
            });
    ...
    const deleteProject = async (project_id) => {
        try {
            await axios.delete(`http://localhost:3000/api/projects/project/${project_id}`, {withCredentials: true});
    ...
    const addTool = async (projectID, tool) => {
        ...
        try {
            const response = await axios.post(`http://localhost:3000/api/projects/tool/${projectID}`, tool, {withCredentials: true}, {  
    ...
    const removeTool = async (projectId, toolId) => {
        ...
        console.log(toolId);
        try {
            const response = await axios.delete(`http://localhost:3000/api/projects/tool/${projectId}/${toolId}`, { withCredentials: true })
            return response.data;
        } catch (error) {
    ...
    const updateTool = async (projectId, toolId, parameters) => {
        try {
            const response = await axios.post(`http://localhost:3000/api/projects/tool/${projectId}`, {
                toolId,
                parameters,
              },
            {
    ...
    const applyTools = async (projectId, toolIds) => {
        try {
            const response = await axios.post(`http://localhost:3000/api/projects/project/applyTools/${projectId}`,
                { toolIds }, 
                { withCredentials: true }
            );
