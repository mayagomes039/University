        ...
        if self.msg_cnt >= 3:
            ...
            if txt.startswith(b"askqueue"):
                ...
                for message in unread_messages:
                    ...
                    t1 = "["+ str(field1) + ", " + str(field2) +", "+ str(field3) + ", "
                    t1 = t1.encode()
                    ...
                    nonce = os.urandom(12)
                    ciphertext = self.aesgcm.encrypt(nonce, tf, None)
            ...
            if txt.startswith(b"getmsg"):
                ...
                if len(parts) == 2:
                    ...
                    if get_messages is not None and msg_number <= len(get_messages) and get_messages[msg_number - 1]:
                        ...
                        first_four_fields = message[:5]
                        field1 = first_four_fields[1]
                        field2 = first_four_fields[3]
                        field3 = first_four_fields[4]
                        t3 = bytes(field2)
                        t4 = bytes(field3)
                        t1 =  str(field1)
                        t1= t1.encode()
                        tS = " _separar_ ".encode('utf-8')
