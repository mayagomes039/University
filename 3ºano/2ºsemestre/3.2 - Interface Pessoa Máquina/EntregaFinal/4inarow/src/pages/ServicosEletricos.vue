<template>
    <div>
      <NavBar title="Serviços Elétricos" />
      <div class="box">
        <h2>Serviços Atribuídos</h2>
        <router-link to="/servicos-atribuidos-eletricos" class="custom-button">Ver Serviços Atribuídos</router-link>
      </div>
      <div class="box">
        <h2>Serviços Concluidos</h2>
        <router-link to="/servicos-concluidos-eletricos" class="custom-button">Ver Serviços Concluidos</router-link>
      </div>
    </div>
  </template>
