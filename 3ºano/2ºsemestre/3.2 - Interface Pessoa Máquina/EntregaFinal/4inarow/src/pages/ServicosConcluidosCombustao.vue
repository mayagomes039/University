        ...
        <nav id="nav">
            ...
            <div class="nav-items">
                <div class="nav-items">
                    ...
                    <router-link to="/servicos-combustao">Voltar atrás</router-link>
                </div>
            </div>
        </nav>
        <h2>Serviços de combustao concluídos</h2>
        <div class="box">
    ...
    computed: {
        filteredServices() {
            return this.services.filter(service => {
                ...
                return ((vehicle && (['gasolina', 'gasoleo'].includes(vehicle['vehicle-typeId']))) || (servicedefinition && servicedefinition['tipo'] === "combustao")) && service.estado === "realizado";
            });
        }
    },
    methods: {
