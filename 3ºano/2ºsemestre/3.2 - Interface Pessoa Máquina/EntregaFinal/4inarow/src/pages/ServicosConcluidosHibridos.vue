    ...
    <div>
        ...
        <div class="nav-items">
            <div class="nav-items">
                ...
                <router-link to="/servicos-hibridos">Voltar atrás</router-link>
            </div>
        </div>
    </nav>
    <h2>Serviços hibridos concluídos</h2>
        <div class="box">
...
export default {
    ...
    computed: {
        ...
        return ((vehicle && vehicle['vehicle-typeId'] === 'hibrido' ) || (servicedefinition && servicedefinition['tipo'] === "hibrido")) && service.estado === "realizado";
    });
    }
    },
    methods: {
