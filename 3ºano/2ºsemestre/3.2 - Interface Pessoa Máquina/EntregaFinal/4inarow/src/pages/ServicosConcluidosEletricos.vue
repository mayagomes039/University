        ...
        <nav id="nav">
            ...
            <div class="nav-items">
                <div class="nav-items">
                    ...
                    <router-link to="/servicos-eletricos">Voltar atrás</router-link>
                </div>
            </div>
        </nav>
        <h2>Serviços eletricos concluídos</h2>
        <div class="box">
    ...
    computed: {
        filteredServices() {
            return this.services.filter(service => {
                ...
                return ((vehicle && (['eletrico'].includes(vehicle['vehicle-typeId']))) || (servicedefinition && servicedefinition['tipo'] === "eletrico")) && service.estado === "realizado";
            });
        }
    },
    methods: {
