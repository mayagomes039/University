<template>
    <div>
        ...
        <h2>Serviços eletricos Atribuídos</h2>
        <div class="box">
    ...
    computed: {
        filteredServices() {
            return this.services.filter(service => {
                ...
                return ((vehicle && vehicle['vehicle-typeId'] === 'eletrico') || (servicedefinition && servicedefinition['tipo'] === "eletrico")) && service.estado !== "realizado";
            });
        }
    },
    methods: {
